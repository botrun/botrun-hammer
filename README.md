...
**Mac 語音轉文字工具** - 按 F5 說話，文字自動輸入到游標位置
...
Botrun Whisper 是一個 Mac 專用的語音輸入工具。只要按下鍵盤上的 **F5** 鍵，就可以開始說話，說完再按一次 **F5**，你說的話就會自動變成文字，輸入到游標所在的位置。
...
1. 確認螢幕右上角有 🔨 圖示（沒有的話開啟 Hammerspoon）
2. 確認已授權「輔助使用」權限
3. 點選 🔨 圖示 → 選「Reload Config」重新載入
